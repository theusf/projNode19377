...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/projnode19377$1.0.0/src/app/views/produtos/listagemProdutos.marko",
...
function render(input, out, __component, component, state) {
  ...
  marko_forEach(data.produtos, function(produto) {
    ...
    out.w("<tr><td>" +
      marko_escapeXml(produto.idProd) +
      "</td><td>" +
      marko_escapeXml(produto.descProd) +
      "</td><td>" +
      marko_escapeXml(produto.idCatProd) +
      "</td><td>" +
      marko_escapeXml(produto.descTecProd) +
      "</td><td>" +
      marko_escapeXml(produto.valorProd) +
      "</td></tr>");
  });
...
marko_template.meta = {
    id: "/projnode19377$1.0.0/src/app/views/produtos/listagemProdutos.marko",
    tags: [
